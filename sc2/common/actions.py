...
class SGIArguments(collections.namedtuple("Arguments", [
    "screen", "queued", "select_point_act", "select_worker"])):
...
ARG_TYPES = SGIArguments.types(
        screen=ArgumentType.point(), # 84*84
        queued=ArgumentType.enum(QUEUED_OPTIONS, Queued), # 2
        select_point_act=ArgumentType.enum(  # 4
                    SELECT_POINT_ACT_OPTIONS, SelectPointAct),
        select_worker=ArgumentType.enum(SELECT_WORKER_OPTIONS, SelectWorker),  # 4
)
...
'''
Collection of action ids for Terran units.
All the actions that are for the other races are commented.
'''
_TERRAN_FUNCTIONS = [
    ...
    Function.ability(39, "Build_Armory_screen", cmd_screen, 331),  # XXX
    #Function.ability(40, "Build_Assimilator_screen", cmd_screen, 882),
    #Function.ability(41, "Build_BanelingNest_screen", cmd_screen, 1162),
    Function.ability(42, "Build_Barracks_screen", cmd_screen, 321),  # XXX
    Function.ability(43, "Build_Bunker_screen", cmd_screen, 324),  # XXX
    Function.ability(44, "Build_CommandCenter_screen", cmd_screen, 318),  # XXX
    ...
    Function.ability(50, "Build_EngineeringBay_screen", cmd_screen, 322),  # XXX
    ...
    Function.ability(53, "Build_Factory_screen", cmd_screen, 328),  # XXX
    #Function.ability(54, "Build_FleetBeacon_screen", cmd_screen, 885),
    #Function.ability(55, "Build_Forge_screen", cmd_screen, 884),
    Function.ability(56, "Build_FusionCore_screen", cmd_screen, 333),  # XXX
    #Function.ability(57, "Build_Gateway_screen", cmd_screen, 883),
    Function.ability(58, "Build_GhostAcademy_screen", cmd_screen, 327),  # XXX
    ...
    Function.ability(64, "Build_MissileTurret_screen", cmd_screen, 323),  # XXX
    ...
    Function.ability(71, "Build_Reactor_quick", cmd_quick, 3683),  # XXX
    ...
    Function.ability(79, "Build_Refinery_screen", cmd_screen, 320),  # XXX
    ...
    Function.ability(83, "Build_SensorTower_screen", cmd_screen, 326),  # XXX
    ...
    Function.ability(89, "Build_Starport_screen", cmd_screen, 329),  # XXX #20
    #Function.ability(90, "Build_StasisTrap_screen", cmd_screen, 2505),
    Function.ability(91, "Build_SupplyDepot_screen", cmd_screen, 319),  # XXX
    Function.ability(92, "Build_TechLab_quick", cmd_quick, 3682),  # XXX add-on
